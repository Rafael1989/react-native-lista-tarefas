...
export default class Auth extends Component {
    ...
    render() {
        ...
        const validForm = validations.reduce((t,a) => t && a) // verifica se todas validações são true
        ...
        return (
            <ImageBackground source={backgroundImage} style={styles.background}>  
                ...
                <View style={styles.formContainer}>
                    ...
                    {this.state.stageNew &&
                        <AuthInput icon='asterisk' placeholder='Confirmação de Senha' value={this.state.confirmPassword} style={styles.input} onChangeText={confirmPassword => this.setState({confirmPassword})} secureTextEntry={true}/>
                    }
